 ...
 *6)emptycol         */
static const char *colors[] = {"#cc241d","#fbf1c7","#7a8c5c","#ff6666","#cc9933","#0d131a","#000000"};
...
///-- WORKSPACE NAMES ---//
static const char ewmh_workspaces[] = {"code\0" "www\0" "chat\0" "misc\0" "games"} ;
///--Custom foo---///
...
static key keys[] = {
    ...
    //programinhas
    {  MOD|SHIFT,         XK_Print,      start,             SHCMD("maim -s | xclip -selection clipboard -t image/png") },
    ...
    // Iconify the window
    {  MOD ,              XK_i,          hide,              {}},
    {  MOD |SHIFT,        XK_i,          start,             SHCMD("hidden -c | xargs 9menu -popup -label Iconics ") },
